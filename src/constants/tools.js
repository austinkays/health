  ...
  },
  {
    ...
    input_schema: {
      ...
      properties: {
        ...
        triggers: { type: 'string', description: 'What triggered symptoms, stressful event, poor sleep, missed meal, weather, etc.' },
        interventions: { type: 'string', description: 'What helped or what the user tried, walk, breathing exercises, medication, rest, etc.' },
        adherence: { type: 'object', description: 'Medication adherence: keys are medication IDs, values are true (taken) or false (skipped)' },
      },
      required: ['content'],
    },
  },  {

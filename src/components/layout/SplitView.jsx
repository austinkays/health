 ...
 */
export default function SplitView({ list, detail, emptyMessage = 'Select an item to view details' }) {
      ...
      <div className="flex-1 overflow-y-auto max-h-[calc(100vh-140px)] no-scrollbar">
        {detail ? (
          ...
          <div className="flex items-center justify-center h-64">
            <p className="text-salve-textFaint text-sm font-montserrat italic">{emptyMessage}</p>
          </div>
        )}
      </div>
    </div>

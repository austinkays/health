  ...
  return (
    ...
    >
      <div className="max-w-[480px] mx-auto px-4 py-2 flex items-center gap-2 md:max-w-[720px] lg:max-w-[960px]">
        ...
        <button
          onClick={onExit}
          className="text-[11px] font-medium text-salve-lav hover:text-salve-text bg-transparent border border-salve-lav/40 hover:border-salve-lav cursor-pointer px-2.5 py-1 rounded-full transition-colors font-montserrat flex-shrink-0"
        >
          Sign up →
        </button>
      </div>

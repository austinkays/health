...
const components = {
  ...
  h3: ({ children }) => <h3 className="text-[13px] font-semibold text-salve-text font-montserrat mt-2.5 mb-1 first:mt-0">{children}</h3>,
  h4: ({ children }) => <h4 className="text-[12px] font-semibold text-salve-text font-montserrat mt-2 mb-0.5">{children}</h4>,
  p: ({ children }) => <p className="text-[13px] text-salve-textMid leading-relaxed my-1.5 first:mt-0 last:mb-0">{children}</p>,
  ...
  li: ({ children }) => <li className="text-[13px] text-salve-textMid leading-relaxed list-disc marker:text-salve-lavDim">{children}</li>,
  ...
  code: ({ inline, children }) => inline
    ? <code className="bg-salve-card2 text-salve-lav text-[12px] px-1.5 py-0.5 rounded">{children}</code>
    : <pre className="bg-salve-card2 border border-salve-border rounded-lg p-3 overflow-x-auto my-2"><code className="text-[12px] text-salve-textMid">{children}</code></pre>,
  ...
  th: ({ children }) => <th className="text-left text-salve-text font-semibold px-2 py-1.5 text-[11px]">{children}</th>,
...
const compactComponents = {
  ...components,
  p: ({ children }) => <p className="text-[12px] text-salve-textMid leading-relaxed my-1 first:mt-0 last:mb-0">{children}</p>,
  h1: ({ children }) => <h1 className="text-[13px] font-semibold text-salve-lav font-playfair mt-2 mb-1 first:mt-0">{children}</h1>,
  h2: ({ children }) => <h2 className="text-[12px] font-semibold text-salve-lav font-playfair mt-2 mb-0.5 first:mt-0">{children}</h2>,
  h3: ({ children }) => <h3 className="text-[12px] font-semibold text-salve-text font-montserrat mt-1.5 mb-0.5 first:mt-0">{children}</h3>,

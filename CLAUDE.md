...
| **Galactic** | Dark | 30-star field drifting left-to-right via GPU-composited `transform: translate()` in a gentle arc (120s cycle, `body::before` 300vw wide) + static nebula wash on `body` + diagonal shooting star every 22s (body::after) |

-- 048_admin_live_users_heatmap.sql
--
-- Extends get_admin_stats() v5 with two new keys:
--   active_now      — count of distinct users with a usage_event in the last 5 minutes
--   hourly_distribution — 24-element array with event count + unique users per UTC hour (7d window)
-- ════════════════════════════════════════════════════════════════════════
...
COMMENT ON FUNCTION get_admin_stats() IS
  'v5 — adds active_now (5-min live user count) and hourly_distribution (7d UTC heatmap).';
